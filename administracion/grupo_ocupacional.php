...
if (isset($_POST['guardar'])){ 
	...
	if ($grupoOcupacional->addGrupoOcupacional($a))
		...
		echo "<script>alert('Se ha generado un problema al registrar los datos del gruo ocupacional')</script>";
}
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <th bgcolor="#CCCCCC" class="texto_adm_negrita" scope="col">NOMBRE GRUPO OCUPACIOAL</th>
